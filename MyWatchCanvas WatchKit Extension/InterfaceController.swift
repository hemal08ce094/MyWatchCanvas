...
class InterfaceController: WKInterfaceController {
    ...
    var selectedPenColor = [UIColor](repeating: UIColor.white, count: 3)
    ...
    func randomColor() {
        ...
        } while penColorHistory.firstIndex(of: randomColor) != nil
    ...
    @IBAction func changeColorPressed() {
        pushController(withName: "ColorPickerController", context: nil)
    }
    ...
    @IBAction func changePenSizePressed() {
        pushController(withName: "PenSizePickerController", context: nil)
